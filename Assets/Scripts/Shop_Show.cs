...
public class Shop_Show : MonoBehaviour
{
    ...
    public GameObject AxePriceText, AxeLumberText, AxeOreText, AxeMessage, HammerPriceText, HammerLumberText, HammerOreText, HammerMessage, HoePriceText, 
    HoeLumberText, HoeOreText, HoeMessage, SicklePriceText, SickleLumberText, SickleOreText, SickleMessage, WaterPriceText, WaterLumberText, WaterOreText, 
    WaterMessage, BuyFodderMessage, BuyCowMessage, BuyChickenMessage, SellMilkMessage, SellEggMessage, BuySeedMessage, SellTomatoMessage;
    ...
    void OnTriggerEnter2D(Collider2D collide)
    {
        ...
        else if(storeName == "Animal Shop"){
            BuyFodderMessage.GetComponent<UnityEngine.UI.Text>().text = "";
            BuyCowMessage.GetComponent<UnityEngine.UI.Text>().text = "";
            BuyChickenMessage.GetComponent<UnityEngine.UI.Text>().text = "";
            SellMilkMessage.GetComponent<UnityEngine.UI.Text>().text = "";
            SellEggMessage.GetComponent<UnityEngine.UI.Text>().text = "";
        }
        else if(storeName == "Plant Shop"){
            BuySeedMessage.GetComponent<UnityEngine.UI.Text>().text = "";
            SellTomatoMessage.GetComponent<UnityEngine.UI.Text>().text = "";
        }
